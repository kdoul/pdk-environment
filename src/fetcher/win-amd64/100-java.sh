...
download adoptopenjdk-x64-windows-jre-${VERSION}.zip \
  https://github.com/adoptium/temurin11-binaries/releases/download/jdk-$(echo $VERSION | sed "s:+:%2B:g")/OpenJDK11U-jre_x64_windows_hotspot_$(echo $VERSION | sed "s:+:_:g").tar.gz
